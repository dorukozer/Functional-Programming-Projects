      ...
      (cases environment env
        ...
        (extend-env (var val saved-env)
          (if (eqv? search-sym var)
           ...
           (if (proc? val )
               (cases proc val
               (nested-procedure (b-var count p-name p-body env) (proc-val val))
                                                                  ;;(nested-procedure b-var count p-name p-body env)))
	(else val))
               val)
        ...
        ; #####################################################
        (extend-env-rec-nested (b-var count p-name p-body saved-env)
          (if (eqv? search-sym p-name)
